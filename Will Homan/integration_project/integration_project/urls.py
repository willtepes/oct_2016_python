...
urlpatterns = [
    ...
    url(r'^', include('apps.integration_app.urls', namespace='integration')),
    ...
    url(r'^ninjas/', include('apps.ninja_turtles.urls', namespace='ninjas')),
    url(r'^gold/', include('apps.ninja_gold.urls', namespace='gold')),
    url(r'^random/', include('apps.randomword.urls', namespace='random')),
]
